...
(deftest test-cost
  ...
  (is (= (cost [(Cell. 0 0 0 :grass 0) (Cell. 1 0 0 :sand 0)] [9 0] traversable ) [11 3 8]))
  )

(deftest test-a*
  ;(is (= (get-path-a* [1 6] [1 1] traversable movement simple-world simple-world-size) [[1 5], [1, 4], [1, 3], [1,2] [1, 1]]))
